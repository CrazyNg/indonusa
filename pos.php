          ...
          <div class="row">
            <div class="col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                <div class="kotak" >
                  ...
                  <input name="judul" type="text"  class="judul" id="judul" style="width: 600px; margin: 0px; height: 50px; font-size:18px" placeholder="Judul Artikel(Max 25 Karakter)" required="" maxlength="25" >
                  <textarea class="ckeditor" id="artikel" name="artikel"></textarea>
				    <font color="black">Jenis Artikel <select id="jenis" name="jenis">
