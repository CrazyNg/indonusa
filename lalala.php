...
======================================================= -->
  ...
  <section id="about">
		...
		<form name="copy">
		  <div align="center">
		    <input name="button"  align="left" type="button" class="tombol" onClick="javascript:this.form.txt.focus();this.form.txt.select();" value="Select All"> <a href="#services" style="color:#000000">


		    <!--<input name="button"  align="left" type="button" class="tombol" value="Komentari">	-->
		  </div>
		  ...
		  <p align="center">
             ...
             mysql_close($sambung);
             ?>  
		    <textarea readonly="readonly" id="loadValue" style="width: 548px; height: 264px; margin: 0px;" name="txt" rows="100" wrap="VIRTUAL" cols="55">
		    <?php echo $buff['artikel']; ?></textarea>
...
$qry=mysql_query($sql);
  while($data = mysql_fetch_array($qry)):?>
    <font color="black">
     <tr align="center">
      <td>
       <a href="index.php?judul=<?php echo $data['judul'];?>"><?php echo $data['judul'] ?></a>
